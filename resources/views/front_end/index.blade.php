            ...
            <li>
              ...
              <div class="seq-title">
               <span data-seq>Save Up to 75% Off</span>                
                ...
                <a data-seq href="{{url('/shop')}}" class="aa-shop-now-btn aa-secondary-btn">SHOP NOW</a>
              </div>
            </li>
            <!-- single slide item -->
            <li>
                    ...
                    <div class="tab-pane fade in active" id="men">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          ...
                          <!-- product badge -->
                          <span class="aa-badge aa-sale" href="#">Men</span>
                        </li>
                        <!-- start single product item -->
                    ...
                    <div class="tab-pane fade" id="women">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          ...
                          <!-- product badge -->
                          <span class="aa-badge aa-sale" href="#">Women</span>
                        </li>
                        <!-- start single product item -->
                    ...
                    <div class="tab-pane fade" id="sports">
                      ...
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          ...
                          <!-- product badge -->
                          <span class="aa-badge aa-sale" href="#">Sport</span>
                        </li>
                        <li>
                    ...
                    <div class="tab-pane fade" id="electronics">
                       <ul class="aa-product-catg">
                        ...
                        <li>
                          ...
                          <!-- product badge -->
                          <span class="aa-badge aa-sale" href="#">Electronics</span>
                        </li>
                        <!-- start single product item -->
